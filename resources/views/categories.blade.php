      ...
      <ul class="page_menu_nav menu_mm">
        <li class="page_menu_item has-children menu_mm">
          ...
          <ul class="page_menu_selection menu_mm">
            <li class="page_menu_item menu_mm"><a href="{{ url('categories') }}">Categories<i class="fa fa-angle-down"></i></a></li>
            <li class="page_menu_item menu_mm"><a href="{{url('product')}}">Product<i class="fa fa-angle-down"></i></a></li>
            <li class="page_menu_item menu_mm"><a href="{{ url('cart')}}">Cart<i class="fa fa-angle-down"></i></a></li>
            <li class="page_menu_item menu_mm"><a href="{{ url('check')}}">Checkout<i class="fa fa-angle-down"></i></a></li>
            <li class="page_menu_item menu_mm"><a href="contact.html">Contact<i class="fa fa-angle-down"></i></a></li>
          </ul>
        </li>
        <li class="page_menu_item has-children menu_mm">
          <a href="{{ url('categories') }}">Categories<i class="fa fa-angle-down"></i></a>
          <ul class="page_menu_selection menu_mm">
            <li class="page_menu_item menu_mm"><a href="{{ url('categories') }}">Category<i class="fa fa-angle-down"></i></a></li>
            <li class="page_menu_item menu_mm"><a href="{{ url('categories') }}">Category<i class="fa fa-angle-down"></i></a></li>
            <li class="page_menu_item menu_mm"><a href="{{ url('categories') }}">Category<i class="fa fa-angle-down"></i></a></li>
            <li class="page_menu_item menu_mm"><a href="{{ url('categories') }}">Category<i class="fa fa-angle-down"></i></a></li>
          </ul>
        </li>
        <li class="page_menu_item menu_mm"><a href="{{url('home') }}">Accessories<i class="fa fa-angle-down"></i></a></li>
...
<div class="home">
  <div class="home_container">
    <div class="home_background" style="background-image: url(image_project/full.jpg)"></div>
    <div class="home_content_container">
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="home_content">
              <div class="home_title" style="color:black">Change your World<span>.</span></div>
